...
class Product extends Model
{
    ...
    public function auction(): HasOne { return $this->hasOne(Auction::class); }
    public function toSearchableArray(): array { return $this->only(['id', 'country_id', 'city_id', 'category_id', 'currency_id', 'title', 'description', 'condition', 'status']); }
}
