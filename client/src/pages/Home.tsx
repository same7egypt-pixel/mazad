  ...
  return <main dir="rtl" className="min-h-screen overflow-x-hidden bg-[#f7f6f1] text-[#143039]">
    <div className="border-b border-white/10 bg-[#12313a] text-[#dce9e3]">
      <div className="market-container flex h-10 items-center justify-between text-xs">
        <span className="flex items-center gap-2"><ShieldCheck size={14} className="text-[#c7dcae]" /> {isLive ? "مزادات حية بحسب الدولة" : "تجربة استكشاف مؤقتة"}</span>
    ...
    <footer className="border-t border-[#143039]/10 py-8"><div className="market-container flex flex-col justify-between gap-4 text-xs text-[#718187] sm:flex-row"><span>© 2026 مِزَاد · {isLive ? "منصة مزادات متصلة" : "تجربة استكشاف مؤقتة"}</span><div className="flex gap-5"><a href="#how">عن المنصة</a><a href="#auctions">المزادات</a><a href="#sell">البائعون</a></div></div></footer>
  </main>;
}
